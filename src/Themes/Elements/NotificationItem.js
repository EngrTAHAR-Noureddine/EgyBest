...
function NotificationItem(prop) {
    ...
    return(
        <Card  style={(prop.isArabic)?flex_styles.row_reverse_space_btn:flex_styles.row_space_btn}
               sx={{width:'90%', height:'10vh', backgroundColor:white_05, mb:2 ,alignItems:'center',px:2}}>
                <TYPOGRAPHY_NOTIFICATION notification={string.NOTIFICATION_TEXT()}/>
                <IconButton sx={{height:'fit-content'}} onClick={()=>prop.click(prop.i)}>
